  ...
  var deliciousaApp = {
    ...
    menu_script: function () {
      ...
      if ($(".mobile-shop-cart").length) {
        var mobileShopCart = $(".header-card-area")
          .clone()
          .appendTo(".mobile-shop-cart");
      }
      if ($(".mobile-sidebar-menu").length && w < 1200) {
        var mobileShopCart = $(".site-navigation .navigation")
          .clone()
      ...
      if (
        ...
        $(".mainmenu li > .sub-menu")
          .siblings("a")
          .append("<span class='menu-arrow fa fa-angle-down'></span>");
      }
      if (
        $(".sidebar-left-menu .mainmenu")
          .find("li > a")
          .siblings(".sub-menu-outer")
      ) {
        $(".mainmenu li > .sub-menu-outer")
          .siblings("a")
          .append("<span class='menu-arrow fa fa-angle-down'></span>");
      }
      ...
      $mobileSubMenuOpen.on("click", function () {
        ...
        if ($(".site-content.sidebar-menu-active").length) {
          ...
          $(
            ".site-content.sidebar-menu-active + .sidebar-menu-area"
    ...
    foodmenu_carousel: function () {
      ...
      $(".food-menu-block.style-two .carousel-nav-text .btn-prev").click(
        function () {
          $foodmenu_carousel1.trigger("prev.owl.carousel");
        }
      );
      $(".food-menu-block.style-two .carousel-nav-text .btn-next").click(
        function () {
      ...
      $(".food-menu-block.style-six .carousel-nav-text .btn-prev").click(
        function () {
          $foodmenu_carousel2.trigger("prev.owl.carousel");
        }
      );
      $(".food-menu-block.style-six .carousel-nav-text .btn-next").click(
        function () {
    ...
    single_food: function () {
      ...
      if ($(".food-detail-slide").length > 0) {
        ...
        $(".thumbnails a").click(function (event) {
          ...
          $(".food-detail-slide").trigger("to.owl.carousel", [
            index,
            300,
            true,
          ]);
    ...
    related_foodmenu_carousel: function () {
      ...
      $(".related-foodmenu-block .carousel-nav-text .btn-prev").click(
        function () {
          $related_foodmenu.trigger("prev.owl.carousel");
        }
      );
      $(".related-foodmenu-block .carousel-nav-text .btn-next").click(
        function () {
    ...
    product_food_carousel: function () {
      ...
      $(".product-block-carousel-nav .carousel-nav-text .btn-prev").click(
        function () {
          $product_food2.trigger("prev.owl.carousel");
        }
      );
      $(".product-block-carousel-nav .carousel-nav-text .btn-next").click(
        function () {
      ...
      $(".our-product-block.style-four .carousel-nav-text .btn-prev").click(
        function () {
          $product_food3.trigger("prev.owl.carousel");
        }
      );
      $(".our-product-block.style-four .carousel-nav-text .btn-next").click(
        function () {
    ...
    reservationScript: function () {
      ...
      $("#reser-submit").on("click", function () {
        ...
        var data =
          ...
          booking_type.val() +
          "&comment2=" +
          encodeURIComponent(comment2.val());
